...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names = 'class',
        title = f'Success Rate of Launch Site {entered_site}')
        return fig
# TASK 4:
...
def get_scatter_chart(entered_site,payload):
    ...
    if entered_site=='ALL':
        fig=px.scatter(scatter_df,x='Payload Mass (kg)',y='class',
                       ...
                       title='Success Count of Payload Mass for All Sites')
        return fig
    else:
        fig=px.scatter(scatter_df[scatter_df['Launch Site']==entered_site],
        x='Payload Mass (kg)',y='class',
        color='Booster Version Category',
        title=f"Success Count of Payload Mass for Site {entered_site}")
        return fig
# Run the app
